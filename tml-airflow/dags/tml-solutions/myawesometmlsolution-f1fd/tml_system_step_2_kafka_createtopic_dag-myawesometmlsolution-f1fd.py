...
@dag(dag_id="tml_system_step_2_kafka_createtopic_dag_myawesometmlsolution-f1fd", default_args=default_args, tags=["tml_system_step_2_kafka_createtopic_dag_myawesometmlsolution-f1fd"], start_date=datetime(2023, 1, 1), schedule=None,catchup=False)
def startkafkasetup():
    def empty():
        pass
dag = startkafkasetup()
