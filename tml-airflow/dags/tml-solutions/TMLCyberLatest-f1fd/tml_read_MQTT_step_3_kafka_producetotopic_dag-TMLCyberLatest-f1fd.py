...
default_args = {
  ...
  'mqtt_broker' : '28894864c884409db874f9f5a6f095b9.s1.eu.hivemq.cloud', # <<<****** Enter MQTT broker i.e. test.mosquitto.org
...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_TMLCyberLatest-f1fd", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_TMLCyberLatest-f1fd"], schedule=None,catchup=False)
