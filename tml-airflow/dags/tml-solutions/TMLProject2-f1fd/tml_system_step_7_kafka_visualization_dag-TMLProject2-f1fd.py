...
@dag(dag_id="tml_system_step_7_kafka_visualization_dag_TMLProject2-f1fd", default_args=default_args, tags=["tml_system_step_7_kafka_visualization_dag_TMLProject2-f1fd"], schedule=None,catchup=False)
def startstreaming():    
  def empty():
      pass
dag = startstreaming()
