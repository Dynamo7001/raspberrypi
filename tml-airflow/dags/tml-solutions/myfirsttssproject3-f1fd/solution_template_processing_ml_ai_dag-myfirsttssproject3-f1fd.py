...
step3 = importlib.import_module("tml-solutions.myfirsttssproject3-f1fd.tml_read_LOCALFILE_step_3_kafka_producetotopic_dag-myfirsttssproject3-f1fd")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_dag-myfirsttssproject3-f1fd",
