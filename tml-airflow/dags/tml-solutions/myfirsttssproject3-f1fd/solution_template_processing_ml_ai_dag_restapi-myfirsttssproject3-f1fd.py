...
step1 = importlib.import_module("tml-solutions.myfirsttssproject3-f1fd.tml_system_step_1_getparams_dag-myfirsttssproject3-f1fd")
step2 = importlib.import_module("tml-solutions.myfirsttssproject3-f1fd.tml_system_step_2_kafka_createtopic_dag-myfirsttssproject3-f1fd")
step3 = importlib.import_module("tml-solutions.myfirsttssproject3-f1fd.tml_read_RESTAPI_step_3_kafka_producetotopic_dag-myfirsttssproject3-f1fd")
step4 = importlib.import_module("tml-solutions.myfirsttssproject3-f1fd.tml_system_step_4_kafka_preprocess_dag-myfirsttssproject3-f1fd")
step5 = importlib.import_module("tml-solutions.myfirsttssproject3-f1fd.tml_system_step_5_kafka_machine_learning_dag-myfirsttssproject3-f1fd")
step6 = importlib.import_module("tml-solutions.myfirsttssproject3-f1fd.tml_system_step_6_kafka_predictions_dag-myfirsttssproject3-f1fd")
step7 = importlib.import_module("tml-solutions.myfirsttssproject3-f1fd.tml_system_step_7_kafka_visualization_dag-myfirsttssproject3-f1fd")
step8 = importlib.import_module("tml-solutions.myfirsttssproject3-f1fd.tml_system_step_8_deploy_solution_to_docker_dag-myfirsttssproject3-f1fd")
step9 = importlib.import_module("tml-solutions.myfirsttssproject3-f1fd.tml_system_step_9_privategpt_qdrant_dag-myfirsttssproject3-f1fd")
step10 = importlib.import_module("tml-solutions.myfirsttssproject3-f1fd.tml_system_step_10_documentation_dag-myfirsttssproject3-f1fd")


with DAG(
    dag_id="solution_preprocessing_ml_ai_restapi_dag-myfirsttssproject3-f1fd",
