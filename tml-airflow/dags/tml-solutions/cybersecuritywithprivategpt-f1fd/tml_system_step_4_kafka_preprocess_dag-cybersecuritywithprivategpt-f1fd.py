...
@dag(dag_id="tml_system_step_4_kafka_preprocess_dag_cybersecuritywithprivategpt-f1fd", default_args=default_args, tags=["tml_system_step_4_kafka_preprocess_dag_cybersecuritywithprivategpt-f1fd"], start_date=datetime(2023, 1, 1),schedule=None,catchup=False)
def startprocessing():
  def empty():
     pass
dag = startprocessing()
