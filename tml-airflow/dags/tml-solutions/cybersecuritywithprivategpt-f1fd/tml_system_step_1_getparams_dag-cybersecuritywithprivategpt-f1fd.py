...
default_args = {
 ...
 'solutionname': 'cybersecuritywithprivategpt-f1fd',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_cybersecuritywithprivategpt-f1fd", default_args=default_args, tags=["tml_system_step_1_getparams_dag_cybersecuritywithprivategpt-f1fd"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass
